...
import com.likelion.backendplus4.yakplus.drug.infrastructure.persistence.repository.entity.EmbeddingEntity;
...
public class DrugEntityMapper {
    ...
    public static <E extends EmbeddingEntity> Drug toDomainFromEntity(DrugRawDataEntity drugEntity, E embedEntity) {
        return Drug.builder()
                ...
                .vector(DrugMapper.parseJsonToFloatArray(embedEntity.getVector()))
                .build();
    }
}
