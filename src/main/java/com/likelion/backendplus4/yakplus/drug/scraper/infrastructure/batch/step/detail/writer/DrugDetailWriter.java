package com.likelion.backendplus4.yakplus.drug.scraper.infrastructure.batch.step.detail.writer;
...
import com.likelion.backendplus4.yakplus.drug.scraper.infrastructure.persistence.repository.jpa.repository.DrugDetailJpaRepository;
 ...
 * <p>
 * DrugDetailJpaRepository: 의약품 상세정보를 저장하는 JPA Repository
 *
...
public class DrugDetailWriter implements ItemWriter<List<DrugDetailEntity>> {
	...
	private final DrugDetailJpaRepository repository;
	/**
