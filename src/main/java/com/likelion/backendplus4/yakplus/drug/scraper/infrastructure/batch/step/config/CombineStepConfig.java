...
public class CombineStepConfig {
    ...
    private static final String TABLE_COMBINE_ENTITY_FQN =
            "com.likelion.backendplus4.yakplus.drug.scraper.infrastructure.batch.step.combine.dto.TableCombineDto";
    private static final String DRUG_DETAIL_ENTITY = "DrugDetailEntity";
    private static final String DRUG_IMAGE_ENTITY = "DrugImgEntity";
