package com.likelion.backendplus4.yakplus.drug.scraper.infrastructure.support.parser;
...
public class JsonArrayTextParser {
     ...
     */
    public static List<String> extractAndClean(String json)  {
        try{
            ...
            LogUtil.log(LogLevel.ERROR, "텍스트 정제 실패", e);
            return null;
        }
